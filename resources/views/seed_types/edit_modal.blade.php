    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('messages.seed_types.edit_seed_type') }}</h5>
            ...
            <div class="modal-body">
                ...
                {{ Form::hidden('seedTypeId',null,['id'=>'seedTypeId']) }}
                <div class="row">
                    ...
                    <div class="form-group col-sm-6 d-flex">
                        <div class="col-sm-4 col-md-6 pl-0 form-group">
                            ...
                            <label class="image__file-upload btn btn-primary text-white" tabindex="2"> {{ __('messages.common.choose') }}
                                <input type="file" name="image" id="editSeedTypeImage" class="d-none">
                            </label>
                        </div>

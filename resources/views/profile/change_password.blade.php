    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('messages.admin_dashboard.change_password') }}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12">
                        <label>New Password:</label><span
                                class="text-danger confirm-pwd"></span><span class="text-danger">*</span>
                        <div class="input-group">
                ...
                <div class="text-right">
                    <button type="submit" class="btn btn-primary" id="btnPrPasswordEditSave" data-loading-text="<span class='spinner-border spinner-border-sm'></span> Processing...">{{ __('messages.common.save') }}</button>

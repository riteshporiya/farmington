    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('messages.plant_use.edit_plant_use') }}</h5>
            ...
            <div class="modal-body">
                ...
                {{ Form::hidden('plantUseId',null,['id'=>'plantUseId']) }}
                <div class="row">
                    ...
                    <div class="form-group col-sm-6 d-flex">
                        <div class="col-sm-4 col-md-6 pl-0 form-group">
                            ...
                            <label class="image__file-upload btn btn-primary text-white" tabindex="2">{{ __('messages.common.choose') }}
                                <input type="file" name="image" id="editPlantUseImage" class="d-none">
                            </label>
                        </div>

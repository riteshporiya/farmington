                            ...
                            @foreach($plants as $plant)
                                <div class="col-12 col-sm-6 col-lg-4">
                                    <div class="single-product-area mb-50">
                                        <!-- Product Image -->
                                        <div class="">
                                            <a href="{{ route('plant.use.shop.details', $plant->id) }}"><img src="{{ $plant->image_url }}" alt="Plant Type Image" style="height: 414px; width: 350px;"></a>
                                        </div>
                                        <!-- Product Info -->
                                        <div class="product-info mt-15 text-center">
                                            <a href="{{ route('plant.use.shop.details', $plant->id) }}">
                                                <p style="font-weight: bold; font-size: x-large;">{{ $plant->name }}</p>
                                            </a>
                                        </div>
                                    </div>
                                </div>

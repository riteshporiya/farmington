...
let tableName = $('#gardenTypesTable').DataTable({
    scrollX: true,
    deferRender: true,
    scroller: true,
    processing: true,
    ...
    columns: [
        ...
        },
        {
            data: function (row) {
                let data = [{'id': row.id}];
                return prepareTemplateRender('#gardenTypesTemplate',
                    data);
            }, name: 'id',
        },
    ],
...
$(document).on('click', '.edit-btn', function (event) {
    const gardenTypeId = $(event.currentTarget).data('id');
...
$(document).on('click', '.delete-btn', function (event) {
    let gardenTypeId = $(event.currentTarget).data('id');

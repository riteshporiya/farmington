...
/*!********************************************************!*\
  !*** ./resources/assets/js/plant_types/plant-types.js ***!
  \********************************************************/


var tableName = $('#plantTypesTable').DataTable({
  scrollX: true,
  deferRender: true,
  scroller: true,
  processing: true,
  ...
  columns: [{
    data: function data(row) {
      return '<a href="#" class="show-data link-color" data-id="' + row.id + '">' + row.name + '</a>';
    },
    name: 'name'
  }, {
    data: function data(row) {
    ...
    data: function data(row) {
      ...
      return prepareTemplateRender('#plantTypesTemplate', data);
    },
    name: 'id'
  }]
});
...
$(document).on('click', '.edit-btn', function (event) {
  var plantTypeId = $(event.currentTarget).data('id');

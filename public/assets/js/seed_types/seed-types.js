...
/*!******************************************************!*\
  !*** ./resources/assets/js/seed_types/seed-types.js ***!
  \******************************************************/


var tableName = $('#seedTypesTable').DataTable({
  scrollX: true,
  deferRender: true,
  scroller: true,
  processing: true,
  ...
  columns: [{
    ...
    data: function data(row) {
      ...
      return prepareTemplateRender('#seedTypesTemplate', data);
    },
    name: 'id'
  }]
});
...
$(document).on('click', '.edit-btn', function (event) {
  var seedTypeId = $(event.currentTarget).data('id');
